                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="well">
                        ...
                        <div class="row">
                            ...
                            <input type="hidden" name="productionProcessId" id="productionProcessId" value="{{Input::get('productionProcessId')}}" />
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="panel">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                        ...
                                                        <span class="rflabelsteric"><strong>*</strong></span>
                                                        <select name="" disabled id="" class="form-control requiredField" required>
                                                            <?php echo SelectListFacades::getLocationList($m,1,$projectId);?>
                                                        </select>
                                                        <input type="hidden" name="location_id_1" id="location_id_1" value="{{$projectId}}" />
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                    ...
                                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                        <label>Project :</label>
                                                        <span class="rflabelsteric"><strong>*</strong></span>
                                                        <select name="project_id_1" id="project_id_1" class="form-control requiredField" required>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                                        ...
                                                        <span class="rflabelsteric"><strong>*</strong></span>
                                                        <select disabled class="form-control" onchange="loadRecipeDetail()">
                                                            <option value="">Select Option</option>
                                                            @foreach ($recipes as $recipe)                                                                
                                                                <option value="{{ $recipe->id }}" @if($recipe_id == $recipe->id) selected @endif>{{ $recipe->description }}<-->{{ optional($recipe->subItem)->sub_ic }}</option>
                                                            @endforeach
                                                        </select>
                                                    ...
                                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                        ...
                                                        <input type="number" disabled onchange="loadRecipeDetail()" class="form-control requiredField" value="{{$qty}}" />
                                                        <input type="hidden" name="no_of_qty_1" id="no_of_qty_1" value="{{$qty}}" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
