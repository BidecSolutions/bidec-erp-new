	    ...
	    <div class="boking-wrp dp_sdw">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-right">
                    <?php echo CommonFacades::displayPrintButtonInBlade('printMaterialRequestVoucherList','','1');?>
                    <?php echo CommonFacades::displayExportButton('materialRequestVoucherList','','1')?>
                </div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="well">
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <span class="subHeadingLabelClass">View Material Request </span>
                            </div>
                        </div>
                        <div class="lineHeight">&nbsp;</div>
                                        ...
                                        <div class="row">
												<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
													...
													<select name="selectAFilterType" id="selectAFilterType" class="form-control" onchange="optionEnableAndDisableAdvanceFilterField()">														
														<option value="material_request_no">M.R. No</option>
														<option value="material_request_date">M.R. Date</option>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                    <div class="table-responsive scrollme">
                                                        <table class="table table-bordered customTable" id="materialRequestVoucherList">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th class="text-center">All M.R. Item Status</th>
                                                                    <th class="text-center hidden-print">Action</th>
                                                                </tr>
                                                            </thead>
                                                            <tbody id="filterMaterialRequestVoucherList"></tbody>
                                                        </table>
                                                    </div>
                                                </div>
                                            </div>
