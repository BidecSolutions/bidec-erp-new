                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <span class="subHeadingLabelClass">Stock Trash Form</span>
                                    </div>
                                </div>
                                <div class="lineHeight">&nbsp;</div>
                                <div class="row">
                                    <?php echo Form::open(array('url' => 'store/addStockTrash?m='.$m.'','id'=>'addPurchaseReturnDetail','class'=>'stop'));?>
                                                        ...
                                                        <div class="table-responsive">
                                                            <table class="table table-bordered sf-table-list">
                                                                ...
                                                                <tr class="text-center">
                                                                    <th colspan="5" class="text-center">Stock Trash Detail</th>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <th class="text-center">Trash Qty</th>
