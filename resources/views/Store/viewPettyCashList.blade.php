            ...
            <div class="row">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="well">
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <span class="subHeadingLabelClass">View Petty Cash List</span>
                            </div>
                        </div>
                        <div class="lineHeight">&nbsp;</div>
                        <form id="list_data" method="get" action="{{ route('store.addPettyCashList') }}">
                                                        ...
                                                        <table class="table table-bordered customTable" id="purchaseOrderVoucherList">
                                                            <thead>
																<tr>
																	...
																	<th class="text-center" rowspan="2">Invocie #</th>
