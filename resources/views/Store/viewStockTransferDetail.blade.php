...
$MasterData = DB::table('stock_transfers')->where('tr_no','=',$id)->get();
            ...
            <div class="row">
                <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12">
                    <table  class="table table-bordered table-striped table-condensed tableMargin">
                        ...
                        <tr>
                            <td>Stock Transfer Type</td>
                            <td class="text-center">{{ CommonHelper::get_stock_transfer_tpye($row->type) }}</td>
                        </tr>
                        </tbody>
                    </table>
                </div>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="table-responsive">
                    <table  class="table table-bordered table-striped table-condensed tableMargin">
                        ...
                        <?php
                        CommonHelper::companyDatabaseConnection($m);
                        $DetailData = DB::table('stock_transfer_datas')->where('tr_no','=',$id)->get();
                        CommonHelper::reconnectMasterDatabase();
                        $counter = 1;
                        ...
                        <tr>
                            ...
                            <td>
                                {{ CommonFacades::get_location_name($row1->warehouse_to) }}
                            </td>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-top:40px;">
                    <div class="container-fluid">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 text-center">
                                <h6 class="signature_bor">Security: </h6>
                                <b>   <p></p></b>
                            </div>
                            {{-- <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 text-center">
