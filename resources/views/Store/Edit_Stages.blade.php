        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="well">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <span class="subHeadingLabelClass"> Edit Stages 
                                {{-- {{ $purchaseOrderData->purchase_order_no ?? '' }} --}}
                            </span>
                        </div>
                    </div>
                    <div class="lineHeight">&nbsp;</div>

                    <?php echo Form::open(['url' => 'production/updateStages?m=' . $m . '', 'id' => 'addPurchaseOrderDetail']); ?>
                                ...
                                <div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                            <label class="sf-label">Stage Name.</label>
                                            ...
                                            <input type="text" class="form-control requiredField" name="qoutation_no"
                                                ...
                                                value="{{$purchaseOrderData->stage_name}}" />
                                        </div>
