                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="well">
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <span class="subHeadingLabelClass">Create Purchase Request Detail Form</span>
                                </div>
                            </div>
                            ...
                            <input type="hidden" name="totalCounter" readonly id="totalCounter" value="<?php echo count($seletedDemandVoucherListandCreatePurchaseRequest);?>">
                                                    ...
                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                        <div class="table-responsive">
                                                            <table class="table table-bordered sf-table-list">
                                                                ...
                                                                <?php
                                                                $counter1 = 1;
                                                                foreach ($seletedDemandVoucherListandCreatePurchaseRequest as $row){
                                                                ?>
